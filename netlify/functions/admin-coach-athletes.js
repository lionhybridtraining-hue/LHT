    ...
    const normalized = list
      .map((athlete) => {
        ...
        return {
          ...
          name: athlete.name || "",
          email: athlete.email || "",
          strengthLevel: athlete.strength_level || null,
          gymAccess: athlete.gym_access || "full_gym",
          coachStrengthLevelOverride: athlete.coach_strength_level_override || null,
          coachGymAccessOverride: athlete.coach_gym_access_override || null,
          strengthMovementVariant: athlete.strength_movement_variant || "standard",
          strengthLogDetail: athlete.strength_log_detail || "exercise",
